...
export default function Aparcela({ navigation }) {
  return (
    ...
    <Image  style={{width: 66, height: 66, margin: '7%'}} source={require('../../../../assets/agricultorIcones/Parcela.png')}/>
    ...
    <View style={styles.coluna}>
        <View style={styles.row}>
          <Image style={styles.image} source= {require("../../../../assets/interrogacao.png")}/>
            <View>
        ...
        <View style={styles.row}>
            <Image style={[styles.image, {width: 45, height: 48}]} source= {require("../../../../assets/agricultorIcones/pacote.png")}/>
            <View>
