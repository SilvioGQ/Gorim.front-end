   ...
   useEffect (()=> {
    ...
    <View style={styles.container}>
        <View style= {styles.row}>
            <Image style= {styles.image} source= {require('../../assets/agricultorIcones/papel.png')}/>
        ...
        <Image style={styles.linha} source= {Image1}/> 
        </View>
        <View style= {styles.numeros}> 
            <Image style={styles.emoji} source= {require('../../assets/emojis/feliz.png')}/>
            <Image style={styles.emoji} source= {require('../../assets/emojis/meio.png')}/>
            <Image style={styles.emoji} source= {require('../../assets/emojis/preocupado.png')}/>
            <Image style={styles.emoji} source= {require('../../assets/emojis/tenso.png')}/>
            <Image style={styles.emoji} source= {require('../../assets/emojis/corona.png')}/>
        </View>
        ...
        <Text style={[styles.italiano, {fontStyle:'normal'}]}>Você alugou uma semeadeira por preço alto da Empresária 1; {'\n'}
...
Fiscal 1 de Atlantis negou seu pedido de selo verde. </Text>
    </View>
    </ScrollView>
