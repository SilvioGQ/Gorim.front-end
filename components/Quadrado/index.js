...
export default function Quadrados({ player = null, onClick, city = null, backgroundColor, color, icon = null, abr }) {
  return (
    <TouchableOpacity onPress={onClick}  >
      ...
      <View style={[styles.colunm, { backgroundColor: backgroundColor }]} >
        ...
        {player ?
          <Text style={[styles.textinhos, { color: color }]}>{abr ? `${abr}`: ""} {player ? ` - ${city}` : ""}</Text>
          :
          null}
      </View>
    </TouchableOpacity>
