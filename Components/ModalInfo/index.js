            ...
            <View style={{ padding: 15, marginRight: 25 }}>
              <View style={{ flexDirection: 'row' }}>
                <View style={{ width: 32, height: 30, borderRadius: 10, borderColor: '#58AB23', borderWidth: 2.5, marginRight: 5 }}>
                  <Text style={{  fontWeight: 'bold', color: '#58AB23', fontSize: 18, alignSelf: 'center' }}>0+</Text>
                </View>
                <Text style={{ marginBottom: 15, textAlign: 'left',  fontSize: 14 }}>Indica quanto o item faz de produtividade</Text>
              </View>
              <View style={{ flexDirection: 'row' }}>
                <View style={{ width: 32, height: 30, borderRadius: 10, borderColor: '#58AB23', borderWidth: 2.5, marginRight: 5 }}>
                  <Text style={{  fontWeight: 'bold', color: '#58AB23', fontSize: 18, alignSelf: 'center' }}>0x</Text>
                </View>
                <Text style={{ marginBottom: 15, textAlign: 'left',  fontSize: 14 }}>Indica o número para multiplicar o valor de produtividade da semente</Text>
              </View>
              <View style={{ flexDirection: 'row' }}>
                <View style={{ width: 32, height: 30, borderRadius: 10, borderColor: COLORS.warningButton, borderWidth: 2.5, marginRight: 5 }}>
                  <Text style={{  fontWeight: 'bold', color: COLORS.warningButton, fontSize: 18, alignSelf: 'center' }}>0+</Text>
                </View>
                <Text style={{ marginBottom: 15, textAlign: 'left',  fontSize: 14 }}>Indica quanto o item faz de poluição</Text>
              </View>
              <View style={{ flexDirection: 'row' }}>
                <View style={{ width: 32, height: 30, borderRadius: 10, borderColor: COLORS.warningButton, borderWidth: 2.5, marginRight: 5 }}>
                  <Text style={{  fontWeight: 'bold', color: COLORS.warningButton, fontSize: 18, alignSelf: 'center' }}>0x</Text>
                </View>
                <Text style={{ marginBottom: 15, textAlign: 'left',  fontSize: 14 }}>Indica o número para multiplicar o valor da poluição da semente</Text>
              </View>
            </View>
          )}
          <TouchableOpacity
