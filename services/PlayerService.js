                ...
                snapshot.forEach(function (doc) {
                    if (emp >= 1) {
                        ...
                        doc.ref.update({
                            ...
                            coin: 300,
                            inventory: [ 
                                { type: 'seed', name: 'seedRice', amount: 3 },
                                { type: 'seed', name: 'seedSoy', amount: 2 },
                                { type: 'fertilizer', name: 'fertilizerNormal', amount: 2 },
                                { type: 'pesticide', name: 'pesticideNormal', amount: 1 },
                                { type: 'pesticide', name: 'pesticidePremium', amount: 1 },
                                { type: 'pesticide', name: 'pesticideSuperPremium', amount: 1 },
